    ...
    <div className="session-panel-backdrop" onClick={onClose}>
      <div className="session-panel" style={panelStyle} onClick={e => e.stopPropagation()}>
        ...
        <div className="session-panel-body">
          ...
          {/* GitHub repo link */}
          {showGithubLink !== undefined && (
            <div className="session-panel-section">
              <button
                className={`gh-repo-badge gh-repo-badge-panel ${githubRepo ? 'linked' : ''}`}
                onClick={onLinkRepo}
                title={githubRepo ? `Linked: ${githubRepo} (${githubBranch})` : 'Link GitHub repo'}
              >
                <svg width="14" height="14" viewBox="0 0 16 16" fill="currentColor">
                ...
                {githubRepo ? (
                  <span className="gh-repo-badge-name">
                    {githubRepo.split('/')[1] || githubRepo}
                    <span className="gh-repo-badge-branch"> / {githubBranch}</span>
                  </span>
                ) : (
